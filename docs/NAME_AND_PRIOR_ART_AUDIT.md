...
Audit date: 2026-08-16. Exact-name check repeated at 06:44 CST (UTC+8).
...
- The only exact GitHub repository named `DSH-OS26` or `dsh-os26` is the
  published project itself, `OBdangshang07/DSH-OS26`.
...
The latest repeat check returned only `OBdangshang07/DSH-OS26` for both
`DSH-OS26 in:name` and `dsh os26 in:name`. `npm view dsh-os26` still returned
`E404`; no third-party exact-name collision was found.
